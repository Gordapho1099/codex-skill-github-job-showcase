...
5. If you chose Download ZIP:
   - Save the file
   - Open your Downloads folder
   - Right-click the ZIP file
   - Choose Extract All

6. Open the extracted folder and look for the project files.

7. If the repo has a README template or markdown files, open them with a text editor.

8. Copy the parts you need into your own GitHub project page, portfolio page, or resume draft.
...
4. Choose Open with
5. Pick Notepad or Visual Studio Code
6. Make your changes
7. Save the file
...
4. Paste or upload your content
...
## 🛠️ If You Want to Edit the Files
...
5. Try a different folder if needed

If the files do not open:

1. Check the file type
2. Use Notepad or Visual Studio Code
3. Make sure the file is not still inside the ZIP file
...
4. Open the .md file in Notepad
5. Read the sample text
6. Copy the parts you need
7. Paste them into your project page, portfolio, or resume
